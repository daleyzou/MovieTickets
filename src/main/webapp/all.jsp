		...
		<div class="modal-content">
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					...
					<!--/tv-movies-->
					<h3 class="agile_w3_title hor-t"></h3>
		...
		<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									<table id="table-breakpoint">
										...
										<tbody id="all">
										<s:set name="movies" value="#session.movieinfo"/>
										<s:iterator var="m" value="movies">
										  <tr>
											  <td class="w3-list-img"><a href="movie/moviedesc?id=<s:property value="#m.id" />"><img src="images/<s:property value="#m.img" />"/> </a></td>
											  <td><span><a href="movie/moviedesc?id=<s:property value="#m.id" />"><s:property value="#m.name" /></a></span></td>
											  <td><s:property value="#m.director" /></td>
											  <td class="w3-list-info"><s:property value="#m.time" /> </td>
											  <td class="w3-list-info"><input class="btn btn-default" type="button"  data-toggle="modal" data-target="#order" onclick="chooseset('<s:property value="#m.name" />','<s:property value="#m.time" />')" value="选座"></td>
										  </tr>
										</s:iterator>
										</tbody>
									</table>
			...
			<!--//tv-movies-->
					  ...
					  <div class="blog-pagenat-wthree">
								<ul>
									...
									<li><a href="movie/showallmovies?page=0&start=<s:property value="#start" />">首页</a></li>
									<li><a class="frist" href="movie/showallmovies?page=-1&start=<s:property value="#start" />">上一页</a></li>
									<li><a class="last" href="movie/showallmovies?page=1&start=<s:property value="#start" />">下一页</a></li>
								</ul>
								<!--//requested-movies-->
					</div>
				</div>
